  ...
  function buildAssessmentInterpretationSeeds() {
    const seeds = {
      sensory: {
        dimension: '感觉统合',
        rows: [
          [0, 40, 'intervention', '感觉统合能力需要系统支持，当前多个感觉通道的整合效率偏低。', '对日常声音、触觉或运动刺激反应较强或回避明显，动作协调性不足。', '每天安排15分钟的感觉统合游戏，从触觉和本体感优先入手，再逐步扩展到前庭刺激。', '连续四周后，对日常感觉刺激的反应趋于平稳，动作流畅度提升。'],
          [40, 55, 'attention', '感觉统合处于发展中，部分感觉通道需要更多关注。', '在某些场景下容易分心或过度兴奋，运动时偶尔显得笨拙。', '固定每天两个感觉统合活动时段，先从孩子接受度高的触觉游戏开始。', '四周到六周后，对多种感觉刺激的适应度提高，动作协调性改善。'],
          [55, 70, 'medium', '感觉统合基本正常，大部分感觉通道整合良好。', '日常活动中能较好地处理多种感觉信息，偶尔在复杂环境下表现出轻微不适。', '保持每日充足户外活动时间，适当增加攀爬、平衡类游戏。', '维持现有活动量，逐步丰富感觉体验的多样性。'],
          [70, 85, 'good', '感觉统合发展良好，感觉信息处理效率较高。', '在多种环境下能灵活调整身体反应，运动协调性和空间感知能力都不错。', '继续丰富感觉体验，可尝试更复杂的运动项目如球类、游泳。', '保持良好状态，定期提供新的感觉挑战。'],
          [85, 100, 'excellent', '感觉统合能力优秀，感觉处理和动作协调都非常出色。', '在各种环境中表现自如，动作流畅且富有节奏感。', '可尝试竞技类或技巧类运动项目，进一步挖掘运动潜能。', '继续保持多样化运动体验。']
        ]
      },
      focus: {
        dimension: '集中注意',
        rows: [
          [0, 40, 'intervention', '专注维持时间较短，容易受环境干扰影响。', '经常东张西望，任务启动后容易离开，难以在单一任务上停留超过几分钟。', '先优化环境减少视觉听觉干扰，再把任务拆成5分钟小段，每段完成后立刻给积极反馈。', '连续两周后，开始出现更稳定的专注时段，每次可延长至8-10分钟。'],
          [40, 55, 'attention', '专注表现处于发展中，部分场景需要更多支持。', '熟悉任务时较稳定，陌生任务时容易退缩，注意力容易被新鲜事物吸引。', '从孩子熟悉和喜欢的任务开始，逐步增加挑战和时长，中间穿插短暂休息。', '四周内可看到持续专注时间提升，任务切换更流畅。'],
          [55, 70, 'medium', '专注能力基本达标，多数场景下能维持合理注意时长。', '感兴趣的任务专注较好，重复性任务偶尔走神，能在提醒后回到任务。', '用定时器和任务清单帮助孩子自我监控，逐步减少外部提醒频率。', '六周后自我管理能力提升，外部提醒需求减少。'],
          [70, 85, 'good', '专注表现整体稳定，能自主管理注意力。', '大部分任务能从头到尾完成，走神后能自行拉回，不需要频繁提醒。', '继续保持高质量阅读和安静环境，可尝试需要更长专注的深度任务。', '稳定巩固现有专注能力，挑战更复杂的持续性任务。'],
          [85, 100, 'excellent', '专注力出色，能长时间沉浸于复杂任务。', '自控力强，能在有干扰的环境中保持专注，任务完成质量高。', '可安排需要深度思考和创造性的长期项目，进一步发挥专注优势。', '持续提供有深度和挑战性的任务环境。']
        ]
      },
      adhd: {
        dimension: 'ADHD风险',
        rows: [
          [0, 40, 'intervention', '行为表现中有较多与注意力缺陷和多动冲动相关的信号，建议寻求专业评估。', '坐不住、话多、打断他人、难以等待、做事冲动不计后果。', '优先建立清晰的家庭规则和每日结构化流程，固定起床、用餐、作业、玩耍时间。', '结构化环境和明确规则能在两周内看到行为稳定性的改善，但建议同步专业评估。'],
          [40, 55, 'attention', '观察到一些与注意力和冲动控制相关的表现，值得持续关注。', '部分场景下表现出冲动或多动的倾向，但并非持续出现。', '从最影响日常的1-2个场景开始干预，使用行为强化和及时反馈策略。', '四周后核心场景的行为频率下降，孩子对规则的理解更清晰。'],
          [55, 70, 'medium', '注意力和冲动控制在正常范围内，个别场景偶有波动。', '大部分时间能遵守规则和等待，在疲劳或兴奋时可能出现轻微冲动行为。', '继续保持结构化节奏，关注睡眠和运动量对行为的影响。', '保持现有家庭管理策略，定期复评观察趋势。'],
          [70, 85, 'good', '注意力和行为控制良好，ADHD相关表现不明显。', '能较好地遵守规则、等待轮替和完成多步骤指令。', '继续维持结构化环境和规律作息，丰富运动和户外活动。', '长期保持稳定的行为模式。'],
          [85, 100, 'excellent', '执行功能和自我调控能力优秀。', '计划性、组织性和持续注意力都表现出色。', '可引导孩子参与需要长期规划和自我管理的项目。', '持续发展执行功能相关能力。']
        ]
      },
      multi_intelligence: {
        dimension: '多元智能',
        rows: [
          [0, 40, 'intervention', '在多个智能领域表现偏低，可能需要更丰富的刺激和探索机会。', '对各类活动的参与度和表现都不太突出，缺乏明显的兴趣倾向。', '从最容易获得积极体验的领域开始，每天安排不同类型的探索活动。', '四周内可发现孩子在某些领域的兴趣增长和参与度提升。'],
          [40, 55, 'attention', '部分智能领域有待发展，整体表现尚可。', '在某些类型的活动中表现出兴趣但缺乏持续性，优势领域尚不清晰。', '轮换安排不同智能领域的活动，重点观察孩子在哪些领域自然投入时间更长。', '六周内可识别出2-3个有发展潜力的优势领域。'],
          [55, 70, 'medium', '多元智能发展均衡，已有初步优势倾向。', '在不同类型的任务中都能参与，部分领域表现出稳定的兴趣和能力。', '在保持均衡的基础上，对表现出兴趣的领域适当增加投入时间。', '逐步形成1-2个明显的优势智能领域。'],
          [70, 85, 'good', '智能发展态势良好，优势领域突出。', '在多个智能领域有稳定表现，1-2个领域明显领先同龄水平。', '深度发展优势领域的同时，保持其他领域的基本刺激。', '优势领域持续深化，带动其他领域协同发展。'],
          [85, 100, 'excellent', '多元智能全面发展，多个领域表现优异。', '语言、逻辑、空间、运动、音乐等多个领域都表现出色。', '提供更丰富的深度资源和专业指导，支持多领域持续发展。', '保持多领域高水平发展态势。']
        ]
      },
      emotion: {
        dimension: '情绪识别',
        rows: [
          [0, 40, 'intervention', '情绪识别和表达能力需要更多家庭支持。', '情绪来时更容易用哭闹或行为代替语言表达，难以准确说出自己的感受。', '每天用情绪命名和共情短句帮孩子识别感受，先从开心、难过、生气三个基本情绪开始。', '两到四周内孩子能用简单词汇描述自己的情绪状态。'],
          [40, 55, 'attention', '情绪表达正在发展中，需要更多引导和示范。', '能说出基本情绪但不够准确，在强烈情绪下仍然容易失控。', '用绘本和角色扮演帮孩子扩展情绪词汇，每天固定一个情绪分享时间。', '四周后情绪词汇量增加，在低强度情绪下能主动表达。'],
          [55, 70, 'medium', '情绪识别和表达能力基本达标。', '多数情况下能用语言表达感受，在受挫时仍可能出现短暂的情绪爆发。', '帮孩子建立情绪调节三步法：停一停、想一想、说出来，每天练习一次。', '情绪调节策略内化后，爆发频率和强度都会下降。'],
          [70, 85, 'good', '情绪能力发展良好，表达和管理都比较成熟。', '能准确识别和表达多种情绪，也能理解他人的情绪状态。', '引导孩子用写日记或画画的方式整理复杂情绪，培养更深层的情绪觉察。', '情绪管理能力持续提升，同伴关系更加和谐。'],
          [85, 100, 'excellent', '情绪智力出色，共情能力和自我调节都很强。', '善于体察他人情绪，能主动调节自己情绪并为他人提供支持。', '可尝试担任班级或小组中的情绪支持角色，进一步发挥情绪优势。', '持续发展情绪领导力和共情能力。']
        ]
      },
      learning: {
        dimension: '学习适应',
        rows: [
          [0, 40, 'intervention', '学习准备和任务坚持需要重点支持。', '开始慢、拖延多、完成度波动大，对学习任务有明显的回避倾向。', '用固定流程和明确开始动作帮助启动，把任务切成最小可完成单元。', '逐步建立稳定的学习节奏，四周内可见启动时间缩短。'],
          [40, 55, 'attention', '学习适应处于发展中，部分环节需要支持。', '启动困难但进入后能维持，任务完成质量不够稳定。', '在学习前设置5分钟过渡活动帮大脑切换状态，使用番茄钟分段完成任务。', '六周后学习启动更顺畅，任务完成度趋于稳定。'],
          [55, 70, 'medium', '学习适应性基本良好，能独立完成多数任务。', '基本能自主开始学习，但遇到困难时可能需要提醒和鼓励。', '帮孩子建立错题整理和复习的习惯，逐步培养独立解决问题的能力。', '两个月后独立学习能力和自信心都有提升。'],
          [70, 85, 'good', '学习适应能力强，主动性和坚持性都不错。', '能主动规划和完成学习任务，遇到困难会尝试自己解决。', '引入自主学习管理工具，如周计划表和目标追踪表。', '深化自主学习能力，为更高年级的学习做准备。'],
          [85, 100, 'excellent', '学习习惯和能力都非常出色。', '自主性强，善于时间管理和目标设定，学习效率高。', '可尝试探究式学习和跨学科项目，进一步拓展学习深度。', '保持优秀的学习品质和习惯。']
        ]
      }
    };
